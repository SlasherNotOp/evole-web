    ...
    return (
        <main className="relative bg-black-100 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10 px-5">
            <div className="max-w-7xl w-full">
                ...
                <Hero
                    headline="We’re Not Just Marketers — We’re Your Growth Partners."
                    subText="From bold strategies to scroll-stopping content, Evolve Media exists to grow brands with creativity, clarity, and conversion."
                    cta1='Meet the Team'
                />
